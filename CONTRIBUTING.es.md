...
- Revisa estos archivos útiles:
    ...
    - [LICENSE](https://github.com/LinuxBeginnings/Ubuntu-Hyprland/blob/main/LICENSE.md)
    - [README.md](https://github.com/LinuxBeginnings/Ubuntu-Hyprland/blob/main/README.md)

## Contacto

Para preguntas, usa [GitHub Discussions](https://github.com/LinuxBeginnings/Ubuntu-Hyprland/discussions) o el [Servidor de Discord](https://discord.gg/RZJgC7KAKm).
